...
namespace DijkstraForUndirectedGraphs.Utilities.Matrix
{
    class MatrixGenerator
    {
        ...
        public int[][] GetLowRarefactionMatrix()
        {
            int size = Size;
            int b = size * size;
            int lowRarefaction = rn.Next((int)(b * 0.25), (int)(b * 0.35));
        ...
        public int[][] GetMediumRarefactionMatrix()
        {
            ...
            int b = size * size;
            int mediumRarefaction = rn.Next((int)(b * 0.40), (int)(b * 0.8));
